...
#define elf_header(ptr)		((Elf32_Ehdr *)(ptr))
#define elf_shdr(ptr)		((Elf32_Shdr *)((uint8_t *)(ptr) + elf_header(ptr)->e_shoff))
#define elf_phdr(ptr)		((Elf32_Phdr *)((uint8_t *)(ptr) + elf_header(ptr)->e_phoff))
